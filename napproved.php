...
<div align ="center" id="data-form" > 
	...
	<?php 
		...
		$holdadditionalwhereclause = $additionalwhereclause <> ""?" and " . $additionalwhereclause :"";
			...
			$query = "SELECT a.*,b.item,b.itemdesc,b.qty_asked,b.bprice,".
						...
						" WHERE TRIM(a.request) = TRIM(b.request)  and a.refuse = 1 " .
						$holdadditionalwhereclause . " ORDER BY a.loc_date desc";
	...
	<form name="form1" id="form1" method="post" action="">
		...
		<div id="print_table">
		<h3><strong>Cancelled Requisitions  </strong></h3>
