...
<div align="center" id="data-form">
	...
	<form action="" method="get" id="form1">
		<h3><strong>General Ledger Posting </strong></h3>
		<?php
		...
		?>
			...
			<table>
				...
				<tr>
					...
					<td><b>Financial Period : </b>&nbsp;&nbsp;
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="button" name="recalculate" id="submit-button" value="Refresh" onclick="javascript:var $form_periodmonth = $('#periodmonth').val();var $form_preriodyear = $('#periodyear').val();
			...
			<table>
				<tr id="refreshledger" style="display:none" align="center">
					...
					<td>
						<input type="button" name="post_to_gl" id="submit-button" value="Post to GL" title="Click Post to GL if Generated is different from Posted Ledger Entries" onclick="javascript:
			...
			<table border="0" style="border:1px solid black;padding:1px;border-collapse:separate;border-radius:15px">
				<tr>
					<td align="center">
						&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="displaywhat" id="journal" value="journal" checked onclick="javascript: refreshoption();" />&nbsp;&nbsp;<b>Journal Entries</b>&nbsp;&nbsp;&nbsp;
					</td>
					<td>
						&nbsp;&nbsp;<input type="radio" name="displaywhat" id="genledger" value="genledger" onclick="javascript: refreshoption();" />&nbsp;&nbsp;<b>Generated Ledger Entries</b>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;
					</td>
					<td>
						&nbsp;&nbsp;<input type="radio" name="displaywhat" id="ledger" value="ledger" onclick="javascript: refreshoption();" />&nbsp;&nbsp;<b>Posted Ledger Entries</b>
						&nbsp;&nbsp;&nbsp;&nbsp;
					</td>
				</tr>
			</table>
