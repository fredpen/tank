...
<div align ="center" id="data-form" > 
	...
	<form action="" method="POST" id="form1"  enctype="multipart/form-data" >
		<h3><strong><font size='12'>Issue Product</font></strong></h3>
		<?php
				...
				if ($saverecord == 1){
						...
						for ($i=0; $i < $item_count; $i++)
						{
							...
							$average_cost = ($theitemsavgcost[$i]==0)? $thecost[$i]/$theitemsQty[$i]:
																 (($theitemsavgcost[$i] + ($thecost[$i]/$theitemsQty[$i]))/2);
		...
		<table>
		  <tr>
			...
			<td  align="right" nowrap="nowrap">
				<label>
				  <input type="button" name="savebutton" id="submit-button" value="Save Issues" 
...
<script>
	...
	function myAddItem() {
	   ...
	   if ($form_productqty==''){$addrow = $addrow * 0; alert('Please Enter Quantity');}
	   if ($baseprice==''){$addrow = $addrow * 0;alert('Please Enter Base Price');}
