...
<title>IyallaSoft Bizmaap</title>
...
<style>
	...
	@media print{
			...
			#recpt {
					display:block;
					border-radius: 10px ;border : 2px solid olive;
				}
...
<div  align ="center" id="data-form" > 
	...
	<form action="" method="get" id="form1">
		<h3 class= "noprint"><strong><font size='12'>Print Receipt </font></strong></h3>
		...
		{?>
			<div id="print_table" >
				<table  id="recpt" width="60%"  >
					...
					<tr>
						<td > <b>Receipt No : </b></td><td><?php echo $refno ; ?></td>
					</tr>
					
					<tr><td><b>Payment Date : </b></td><td><?php echo $pmtdate ; ?></td></tr>
					<tr>
						<td>
							<b>Client :</b><br/>
							<b>Address :</b><br/>
