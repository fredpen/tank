...
<div align ="center" id="data-form" > 
	...
	<form action="" method="get" id="form1">
		<h3><strong><font size='10'>Sales Person </font></strong></h3>
		<?php
...
//****			
		...
		<table border="0"  style="border:1px solid black;padding:1px;border-collapse:separate;border-radius:15px">
			<tr >
				...
				<td >
					<input type="text" name="salespsn" id="salespsn" value="<?php echo $salespsn; ?>" <?php if ($salespsn != ''){echo "style='color:gray'" ;echo 'readonly';} ?> placeholder="Enter SalesPerson ID" />
				</td>
				
				<td >
				
					  <input type="button" name="refreshbutton" id="submit-button" value="Refresh" 
						onclick="javascript:  getpage('salesperson.php?','page');" />
...
<script>
	...
	function savecustomer(){
		if (confirm('Are you sure the entries are correct?')) 
		{
			...
			var $form_salespsn = $('#salespsn').val();var $form_salespsnname = $('#salespsnname').val();
	...
	function deletecustomer(){
		if (confirm('Are you sure the entries are correct?')) 
		{
			...
			var $form_salespsn = $('#salespsn').val(); var $form_salespsnname = $('#salespsnname').val();
			var $form_salespsnemail = $('#salespsnemail').val();var $form_salespsnphone = $('#salespsnphone').val();
