...
<div align ="center" id="data-form_report" > 
	...
	<?php 
		include "basicparameters.php";
			...
			$query = "select a.request,a.custno,a.ccompany,a.station,a.loc_date,a.reqst_by, b.item, b.itemdesc, b.qty_asked
				from headdata a, loadings b where trim(a.request)= trim(b.request) and refuse = 1 order by str_to_date(loc_date,'%d/%m/%Y H:s:i A') desc " ;
	...
	<form name="form1" id="form1" method="post" action="">
		...
		<input type = 'hidden' name = 'filename' id='filename' value="refusedreq" />
		...
		<h3><strong><font size='12'>Refused Requisitions</font></strong></h3>
		
		<table style="border:1px solid black;padding:1px;border-collapse:separate;border-radius:15px">
			<tr>
				<td colspan="3">
					Limit :
					<select name="limit" class="table_text1"  id="limit" onchange="javascript:doSearch('refusedreq.php');">
		...
		<table >
			<tr>
				<td align="center">
						<a href="#" onclick="javascript: goFirst('refusedreq.php');">
							<img src="images/first.gif" alt="First" width="16" height="16" border="0"></a> 
						<a href="#" onclick="javascript: goPrevious('refusedreq.php');">
							<img src="images/prev.gif" alt="Previous" width="16" height="16" border="0"></a> 
						<a href="#" onclick="javascript: goNext('refusedreq.php');">
							<img src="images/next.gif" alt="Next" width="16" height="16" border="0"/></a> 
						<a href="#" onclick="javascript: goLast('refusedreq.php');">
							<img src="images/last.gif" alt="Last" width="16" height="16" border="0"/></a>
				</td>
			</tr>
			<tr>
				<td>
					<input type="button" name="closebutton" id="submit-button" value="List Approvals" 
						onclick="javascript:  getpage('approvedreqlist.php?','page');" />
						...
						<table width="95%" cellspacing="1" class="menu_backcolor" id="userlistTable"  style="border:1px solid black;padding:1px;border-collapse:separate;border-radius:15px">
							...
							?>
									...
									<tr <?php echo ($k%2==0)?"class='treven'":"class='trodd'"; ?> >
										...
										<td nowrap="nowrap">
											<a href="javascript:getpage('fastapproval.php?op=edit&request=<?php echo $row["request"];?>','page')">View Details</a></td>
									</tr>
							<?php 
									//} //End For Loop
								} //End If Result Test	
