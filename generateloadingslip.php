	...
	<form action="" method="get" id="form1">
		...
		?>
			...
			<table border="0" style="border:1px solid black;padding:1px;border-collapse:separate;border-radius:15px">
				<tr>
					<td align="center">
						&nbsp;&nbsp;<input type="radio" name="displaywhat" id="singleapproval" value="singleapproval" <?php if ($displaywhat == 1) {
																															echo 'checked';
					...
					<td align="center">
						&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="displaywhat" id="multipleapproval" value="multipleapproval" <?php if ($displaywhat == 2) {
																													echo 'checked';
			...
			<br />
			<div style="color:red;" id="item_error" align="center"></div><?php if (isset($slip_no)) {
																				echo '<b>' . $slip_no . '</b>';
																			} ?>
			<div id="singleapproval_table" <?php if ($displaywhat == 1) {
			...
			<div id="multipleapproval_table" <?php if ($displaywhat == 1) {
													echo 'style="display:none;"';
												} else {
													echo 'style="display:block;"';
												} ?>>
			...
			<?php } ?>
			<div style="overflow-x:auto;" id="single_approval_product_row" <?php if ($displaywhat == 1) {
																				echo 'style="display:block;"';
																			} else {
																				echo 'style="display:none;"';
																			} ?>>
			...
			<div style="overflow-x:auto;" id="multiple_approval_product_row" <?php if ($displaywhat == 1) {
																					echo 'style="display:none;"';
																				} ?>>
			...
			<table>
				<tr>
					...
					<td align="right" nowrap="nowrap">
						<label>
							<input type="button" name="approvebutton" id="submit-button" title="Generate Loading Slip" value="Generate" onclick="javascript: generateslip();">
						</label>
					</td>
					...
					<td>
						<?php $calledby = 'generateloadingslip';
						$reportid = 39;
