...
if(isset($_POST['forgotSubmit'])){
    ...
    if(!empty($_POST['email'])){
        ...
        if($numrows > 0){
            ...
            $resetPassLink = 'https://bizmaap.iyallasoft.com.ng/resetpassword.php?fp_code='.$uniqidStr;
			...
			<br/><br/>Regards,
			<br/>Iyallasoft Administrator';
			//set content-type header for sending HTML email
			$headers = "MIME-Version: 1.0" . "\r\n";
			$headers .= "Content-type:text/html;charset=UTF-8" . "\r\n";
			//additional headers
			$headers .= 'From: Iyallasoft Support Admin<support@iyallasoft.com.ng>' . "\r\n";
			//send email
