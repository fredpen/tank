...
<div align ="center" id="data-form" > 
	<?php 
		...
		include "reportcondition.php";
			...
			$query = "SELECT a.invoice_no, a.slip_no, a.approval1 ,a.approval, a.invoice_dt, a.custno, a.ccompany,".
				" a.loccd, a.loc_name, a.reversed,a.capacity, b.item,b.itemdesc,b.qty_booked,b.store_qty,b.bprice,".
				" b.disc, b.duprice,b.vatduprice,b.price,a.vehc_miss,a.vehcno,a.trasno, a.tcompany FROM invoice a,inv_detl b ".
				" WHERE trim(a.slip_no) = trim(b.slip_no) AND a.vehc_miss = 1 AND trim(a.invoice_no) <> ''  ".
						$holdadditionalwhereclause . " ORDER BY a.invoice_no";
	...
	<form name="form1" id="form1" method="post" action="">
		...
		<div id="print_table">
		<h3><strong>BRVs not Registered in the System</strong></h3>
		<table >
						...
						<table  border="0" cellpadding="5" cellspacing="1" class="menu_backcolor" id="userlistTable">
							<thead>
								<tr class="right_backcolor">
									<th   class="Corner">&nbsp;</th>
									<th   class="Odd">S/N</th>
									<th   class="Odd">Vehicle No:</th>
									<th   class="Odd">Transporter</th>
									<th   class="Odd">Capacity</th>
							...
							?>
									...
									<tr <?php echo ($k%2==0)?"class='treven'":"class='trodd'"; ?> >
										...
										<td  ><?php echo trim($row["trasno"]) ."-" . trim($row["company"]);?></td>
