...
<div align ="center" id="data-form" > 
	...
	<?php 
		...
		include "reportcondition.php";
			...
			$query = "SELECT a.*,b.company FROM tbvehc a , tbtras b WHERE trim(a.trasno) = trim(b.trasno) " .
						$holdadditionalwhereclause . " ORDER by a.trasno, a.vehcno ";
	...
	<form name="form1" id="form1" method="post" action="">
		...
		<div id="print_table">
		<h3><strong>Vehicle Master</strong></h3>
		<table >
						...
						<table  border="0" cellpadding="5" cellspacing="1" class="menu_backcolor" id="userlistTable">
							...
							?>
									...
									<tr <?php echo ($k%2==0)?"class='treven'":"class='trodd'"; ?> >
										...
										<td   align="right"><?php echo number_format($row['capacity'],2);?></td>
										<td  ></td>
									</tr>
							<?php 
									//} //End For Loop
