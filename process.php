...
$officialemail = "info@iyallasoft.com.ng";
...
if ($count_QueryStmt > 0){
    ...
    if($formok){
        $headers = "From: IyallaSoft Technologies <info@iyallasoft.com.ng>" . "\r\n";
		$headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
        ...
        $emailbody = "<p><strong>Dear </strong> {$name} </p>
                      ...
                      <p><strong>for: Iyallasoft EstateAdmin </strong>  </p>
                      <p>https://iyallasoft.com.ng</p>";
