			...
			<div style="overflow-x:auto;">
				<table border="0" style="border:1px solid black;padding:1px;border-collapse:separate;border-radius:15px">
					<tr>
						...
						<td>
							<input type="text" name="catcd" id="catcd" value="<?php echo $catcd; ?>" <?php if ($catcd != '') {
																											echo 'style="background-color:lightgray" readonly';
																										} ?> placeholder="Enter Category ID" />
						</td>
						<td>

							<input type="button" name="refreshbutton" id="submit-button" value="Refresh" onclick="javascript:  getpage('catg.php?','page');" />
				...
				<table>
					...
					<tr>
						...
						<td>
							<input type="button" name="closebutton" id="submit-button" value="Back" onclick="javascript:  getpage('systemconfig.php?','page');" />
						</td>
						<td>

							<input type="button" name="deletebutton" id="submit-button" value="Delete" onclick="deletecatg();" />

						</td>

						<td>

							<input type="button" name="savebutton" id="submit-button" value="Save" onclick="savecatg();" />
