...
<div align ="center" id="data-form_500" > 
	...
	<form action="" method="get" id="form1">
		<h3><strong><font size='8'>Item At Sub Location </font></strong></h3>
		<?php
				...
				if($op=='searchkeyword')
					{
						...
						if (strlen($keyword)!=0) {$sql_Q = $sql_Q . " and 1 = 1 ";}else {$sql_Q = $sql_Q . " and 1 = 2 ";}
						$orderby = "   ";
						$orderflag	= " ";
...
//****			
		...
		<table border="0"  style="border:1px solid black;padding:1px;border-collapse:separate;border-radius:15px">
			<tr >
				...
				<td>
					<input type="text" name="subloc" id="subloc" value="<?php echo $subloc; ?>" <?php if ($subloc != ''){echo 'readonly';} ?> placeholder="Enter Sub Location ID" />
				</td>
			...
			<tr>
				...
				<td >
					  ...
					  <input type="button" name="refreshbutton" id="submit-button" value="Refresh" 
						onclick="javascript:  getpage('itematsublocation.php?','page');" />
...
<script>
	...
	function savelocation(){
		if (confirm('Are you sure the entries are correct?')) 
		{
			...
			var $form_loccd = $('#selectloccd').val();$form_subloc = $('#subloc').val(); var $form_item = $('#selectitem').val();
