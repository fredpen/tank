...
<div align ="center" id="data-form" > 
	...
	<form action="" method="get" id="form1">
		<h3><strong><font size='10'>Customer Master </font></strong></h3>
		<?php
...
//****			
		...
		<table border="0"  style="border:1px solid black;padding:1px;border-collapse:separate;border-radius:15px">
			<tr >
				...
				<td >
					<input type="text" name="custno" id="custno" value="<?php echo $custno; ?>" <?php if ($custno != ''){echo "style='color:lightgray'" ;echo 'readonly';} ?> placeholder="Enter Customer ID" />
				</td>
				
				<td >
					<div title="Tick if Customer Name is editable at Requisition, ideal to handle one off Customers!"><b>Editable&nbsp;&nbsp;&nbsp;<input type="checkbox" id="editable" name="editable" <?php if ($editable==1) {echo 'checked';} ?> /></div>
				
				</td>
				<td >
				
					  <input type="button" name="refreshbutton"  title="Click to prepare form for a New Customer creation" id="submit-button" value="Refresh" 
						onclick="javascript:  getpage('customers.php?','page');" />
		...
		<table>
			...
			<tr>
				...
				<td nowrap="nowrap">
					  ...
					  <input title="Customer Specific Discount" type="button" name="spedisc" id="submit-button" value="Discount" 
						onclick="javascript: specialdisc();">
				...
				<td nowrap="nowrap">
					...
					<?php $calledby = 'customers'; $reportid = 31; include("specificreportlink.php");  ?>
				</td>
...
<script>
	...
	{
		var $form_custno = $('#custno').val();var $form_company = $('#company').val();
		var $goahead = 1;
	...
	function savecustomer(){
		if (confirm('Are you sure the entries are correct?')) 
		{
			...
			var $form_custno = $('#custno').val();$form_address1 = $('#address1').val(); var $form_company = $('#company').val();
			var $form_address2 = $('#address2').val();var $form_email = $('#email').val();var $form_city = $('#city').val();
			var $form_contact = $('#contact').val();var $form_phone1 = $('#phone1').val();var $form_alpha3code = $('#alpha3code').val();
				
			var $form_category = $('#category').val();var $form_bu = $('#bu').val();
			var $form_crlimit = $('#crlimit').val();var $form_retarget = $('#retarget').val();
			
			if (document.getElementById("editable").checked){
				$form_editable = 1;
			}else {$form_editable = 0;}
	...
	function deletecustomer(){
		if (confirm('Are you sure the entries are correct?')) 
		{
			...
			var $form_custno = $('#custno').val();$form_address1 = $('#address1').val(); var $form_company = $('#company').val();
			var $form_address2 = $('#address2').val();var $form_email = $('#email').val();var $form_city = $('#city').val();
				var $form_contact = $('#contact').val();var $form_phone1 = $('#phone1').val();
