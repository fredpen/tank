			...
			<table border="0" cellspacing="1" style="border:1px solid black;padding:10px;border-collapse:separate;border-radius:15px">
				...
				<?php switch (true)
				{
					case ($reportname=='rec_invent' || $reportname=='inv_issues') : ?>
						...
						<h3><strong><font size='7'>Received Products</font></strong></h3>
						<?php } else {?>
						<h3><strong><font size='7'>Issued Products</font></strong></h3>
						<?php } ?>
				...
				?>
					...
					<h3><strong><font size='7'>Loading Slips</font></strong></h3>
					<div style="max-height: 300px; overflow-y: auto;overflow-x: auto;">
					<table  id="reporttable" class="table table-striped table-bordered" style="width:90%" >
							<thead>
								<tr class="right_backcolor">
				...
				?>
					...
					<h3><strong><font size='7'>Way Bills</font></strong></h3>
					<div style="max-height: 300px; overflow-y: auto;overflow-x: auto;">
					<table  id="reporttable" class="table table-striped table-bordered" style="width:90%" >
							<thead>
								<tr class="right_backcolor">
				...
				?>
					...
					<h3><strong><font size='7'>Direct Journal Entries</font></strong></h3>
					<div style="max-height: 300px; overflow-y: auto;overflow-x: auto;">
					<table  id="reporttable" class="table table-striped table-bordered" style="width:90%" >
							<thead>
								<tr class="right_backcolor">
