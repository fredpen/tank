...
<div align="center" id="data-form">
	...
	$query = "SELECT  a.*,b.country FROM arcust a left outer join countries b on trim(a.alpha3code) = trim(b.alpha3code) WHERE 1=1" .
	...
	<form name="form1" id="form1" method="post" action="">
		...
		<div id="print_table">
			<p>
			<h3><strong>Customer Master</strong></h3>
			</p>
			<table>
						...
						<table border="0" cellpadding="5" cellspacing="1" class="menu_backcolor" id="userlistTable">
							<thead>
								<tr class="right_backcolor">
									...
									<th class="Odd">Unassigned Amount</th>
									<th class="Odd">Credit Limit</th>
									<th class="Odd">Unreconciled Credit</th>
									<th>&nbsp;</th>
								</tr>
							</thead>
							<?php
							...
							?>
								...
								<tr <?php echo ($k % 2 == 0) ? "class='treven'" : "class='trodd'"; ?>>
									...
									<td><?php echo $row['address1'] . ' ' . $row['address2'] . ' ' . $row['country']; ?></td>
									<td><?php echo trim($row["phone1"]) . "-" . trim($row["phone2"]); ?></td>
									<td align="right"><?php echo  number_format($row["custbal"], 2); ?></td>
									<td align="right"><?php echo  number_format($row["crlimit"], 2); ?></td>
									<td align="right"><?php echo  number_format($row["totcrtrans"], 2); ?></td>
									<td></td>
								</tr>
							<?php
								//} //End For Loop
