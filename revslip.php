...
<div align ="center" id="data-form" > 
	<?php 
		...
		include "reportcondition.php";
			...
			$query = "SELECT a.invoice_dt,a.slip_no,a.invoice_no,a.reversalreason,b.slip_date,a.loc_date,".
					...
					" WHERE trim(a.slip_no) = trim(b.slip_no)  and a.reversed = 1 ".
	...
	<form name="form1" id="form1" method="post" action="">
		...
		<div id="print_table">
		<h3><strong><font size="10">List of Reversed Loading Slips</font></strong></h3>
						...
						<table  border="0" cellpadding="5" cellspacing="1" class="menu_backcolor" id="userlistTable">
							<thead>
								<tr class="right_backcolor">
									...
									<th   class="Odd">Req. Date</th>
									<th   class="Odd">Loading Slip</th>
									<th   class="Odd">Slip Date</th>
							...
							?>
									...
									<tr <?php echo ($k%2==0)?"class='treven'":"class='trodd'"; ?> >
										...
										<td  ><?php echo trim($row['loc_date']);?></td>
										...
										<td  ><?php echo trim($row['reversalreason']);?></td>
										<td  ></td>
									</tr>
							<?php 
									//} //End For Loop
							...
							?>
									...
									<tr <?php echo ($k%2==0)?"class='treven'":"class='trodd'"; ?> >
										<td  >&nbsp;</td>
										<td align="right" colspan="7" ><strong>Summary : </strong></td>
