...
<div align ="center" id="data-form" > 
	...
	<?php 
		...
		//$holdadditionalwhereclause = $additionalwhereclause <> ""?" and " . $additionalwhereclause :"";
			...
			$query = "SELECT  * FROM bank ORDER BY bank_name ";
	...
	<form name="form1" id="form1" method="post" action="">
		...
		<div id="print_table">
		<p ><h3><strong><font size='12'>Banks </font></strong></h3></p>
		<table >
						...
						<table  border="0" cellpadding="5" cellspacing="1" class="menu_backcolor" id="userlistTable">
							<thead>
								<tr class="right_backcolor">
									...
									<th nowrap="nowrap" class="Odd">Bank Code</th>
									<th nowrap="nowrap" class="Odd">Bank Name</th>
							...
							?>
									...
									<tr <?php echo ($k%2==0)?"class='treven'":"class='trodd'"; ?> >
										...
										<td nowrap="nowrap"><?php echo $row['bank_code'];?></td>
										<td nowrap="nowrap"><?php echo $row["bank_name"];?></td>
										<td nowrap="nowrap" align="right"><?php echo number_format($row["bankbal"],2);?></td>
										<td nowrap="nowrap"></td>
									</tr>
							<?php 
									//} //End For Loop
