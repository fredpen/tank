...
<div  align ="center" id="data-form" > 
	...
	<form action="" method="get" id="form1">
		<h3 class= "noprint"><strong><font size='12'>Print Waybill</font></strong></h3>
		
		<?php
			if ($_SESSION['prnwaybill']==1)
			{
				...
				if ($op=='searchkeyword') 
					{
						...
						$filter=" AND trim(invoice_no) like '%$keyword%'   ";
		...
		<input type="hidden" name="thetablename" id="thetablename" value="waybill" />
		<input type="hidden" name="get_file" id="get_file" value="printwaybill" />
		...
		<table class= "tableb"   style="padding:0px;">
			...
			<tr>
				...
				<td nowrap="nowrap" colspan="2">
					<div class="input-group">
						<b>Waybill Number : </b>&nbsp;<input name="invoice_no" type="text" style="background:transparent;border:none;" tabindex="-1" class="table_text1"  id="invoice_no" value="<?php echo $keyword; ?>" />
						
						&nbsp;&nbsp;
							<input type="submit" name="printslip" <?php  if (! empty($invoice_no)) {echo ' style="display:block;"';} else {echo ' style="display:none;"'; }?> class="PrintButton" id="submit-button" formtarget="_blank" value ="Print Waybill" formaction="<?php echo $_SESSION['applicationbase'].'appwaybill.php' ;?>"/>
