...
<div align="center" id="data-form">
	...
	<form action="" method="get" id="form1">
		<h3 class="noprint"><strong>Print Waybill</strong></h3>
				...
				<tr>
					...
					<td nowrap="nowrap" colspan="2">
						<div class="input-group">
							...
							&nbsp;&nbsp;
							<input type="submit" name="printslip" <?php if (!empty($invoice_no)) {
																		echo ' style="display:block;"';
																	} else {
																		echo ' style="display:none;"';
																	} ?> class="PrintButton" id="submit-button" formtarget="_blank" value="Print Waybill" formaction="<?php echo $_SESSION['applicationbase'] . 'appwaybill.php'; ?>" />
