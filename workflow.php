...
include "workflowstatus.php";
$numrows = $count_workflow;
?>
				...
				<tbody>
					...
					?>
						...
						<tr <?php echo ($k % 2 == 0) ? "class='treven'" : "class='trodd'"; ?>>
							...
							<td nowrap="nowrap"> <?php if (trim($row['action']) != '') { ?> <a href="javascript: getpage('<?php echo $row['action']; ?>.php?op=searchkeyword&keyword=<?php echo trim($row['docreference']); ?>
