...
<div align ="center" id="data-form" > 
	...
	<?php 
		...
		include "reportcondition.php";
			...
			$query = "SELECT a.item,b.itemdesc, a.loccd,a.subloc ,a.onhand, a.wiponhand,a.useable_onhand FROM itemsubloc a, icitem b ".
					" WHERE trim(a.item) = trim(b.item) ".
						$holdadditionalwhereclause . " ORDER BY a.loccd,a.subloc ";
	...
	<form name="form1" id="form1" method="post" action="">
		...
		<div id="print_table">
		<h3><strong>Inventory Position</strong></h3>
		<table >
