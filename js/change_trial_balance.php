									...
									<table width="445" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td nowrap="nowrap" width="131"><select name="eyear" id="eyear">
												...
												<input name="search2" type="button" class="table_text1" id="search2" onclick="javascript:doSearch('change_trial_balance.php')" value="Search" />
											</td>
											<td nowrap="nowrap" width="132"><input name="search3" type="button" class="table_text1" id="search3" onclick="javascript:getpageUpdateGl('1','change_trial_balance.php','page')" value="Delete All Transactions and Loans " /><input type="hidden" id="1" name="1" value="1" /></td>
										</tr>
									</table>
							...
							?>
									<tr <?php echo ($k % 2 == 0) ? "class='treven'" : "class='trodd'"; ?>>
										...
										<td nowrap="nowrap"><input type="text" id="<?php echo $row["ACCT_NO"]; ?>" name="<?php echo $row["ACCT_NO"]; ?>" value="<?php echo $row["debitbal"]; ?>" />
											<input name="search" type="button" class="table_text1" id="search" onclick="javascript:getpageUpdateGl('<?php echo $row["ACCT_NO"]; ?>','change_trial_balance.php','page')" value="Update" />
										</td>
								<?
