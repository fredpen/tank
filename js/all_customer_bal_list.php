...
<tr>
  ...
  <tr class="table_background">
    <td colspan="2"><table border="0" cellspacing="1" class="table_text1" width="100%">
	          ...
	          <td colspan="7" align="center"><div align="center">
	            <table width="363" border="0" cellspacing="0" cellpadding="0">
				  ...
				  ?>
                      ...
                      <a href="#" onclick="getpage('change_all_customer_bal_list.php','page')">Change</a></td>
                  </tr>
                  </table>
	          </div></td>
	        </tr>
		  ...
		  <input name="search2" type="button" class="table_text1" id="search2" onclick="javascript:doSearch('all_customer_bal_list.php')" value="Search"/></td>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
                </tr>
              </table></td>
	          ...
	          <td colspan="7" align="left"><table border="0">
                <tr>
                  ...
                  <td>Page
		              ...
		              &nbsp;
		              <input name="search22" type="button" class="table_text1" id="search22" onclick="javascript:doSearch('all_customer_bal_list.php');" value="Go" /></td>
                </tr>
              </table></td>
          </tr>
	        <tr class="back_image" >
      ...
      <table width="776"  border="0" cellpadding="5" cellspacing="1" class="menu_backcolor" id="accountinfo">
        ...
        <tr <?php echo ($k%2==0)?"class='treven'":"class='trodd'"; ?> >
          <td nowrap="nowrap">&nbsp;</td>
                ...
                <td nowrap="nowrap"><?php echo number_format($all_a["repay_int"],2); $Rep_int+=$all_a["repay_int"];?></td>
                 <?php } ?>
              </tr>
