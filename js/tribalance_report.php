		...
		<table width="903" border="0" align="center" cellpadding="0" cellspacing="0" class="tableborder2" id="list_table">
							...
							<td colspan="7" align="center">
								<div align="center">
									<table width="363" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td width="72" height="22" nowrap="nowrap">Date : </td>
											<td width="44"><select name="eday" id="eday">
													<?php
													for ($i = 1; $i <= 31; $i++) {
														if ($i < 10) $i = '0' . $i;
											...
											<td width="85"><select name="emonth" id="emonth">
											...
											<td width="199"><select name="eyear" id="eyear">
													<?php
													for ($i = 2009; $i <= 2020; $i++) {
												...
												<input name="search2" type="button" class="table_text1" id="search2" onclick="javascript:doSearch('tribalance_report.php')" value="Search" /><a href="#" onclick="getpage('change_trial_balance.php','page')">Change</a>
											</td>
										</tr>
									</table>
								</div>
						...
						<tr class="tr_whitebackground">
							<td colspan="6" nowrap="nowrap">
								<table width="322" border="0">
									<tr>
										<td align="left" nowrap="nowrap"><span class="table_text1"><a href="#" onClick="javascript: goFirst('tribalance_report.php');"><img src="/mfb/images/first.gif" alt="First" width="16" height="16" border="0"></a> <a href="#" onClick="javascript: goPrevious('tribalance_report.php');"><img src="/mfb/images/prev.gif" alt="Previous" width="16" height="16" border="0"></a><a href="#" onClick="javascript: goNext('tribalance_report.php');"><img src="/mfb/images/next.gif" alt="Next" width="16" height="16" border="0" /></a><a href="#" onClick="javascript: goLast('tribalance_report.php');"><img src="/mfb/images/last.gif" alt="Last" width="16" height="16" border="0" /></a></span></td>
									</tr>
								</table>
							</td>
							<td>&nbsp;</td>
			...
			<tr>
				<td width="900" align="left">
					<div id="t2tdiv">
						<table border="0" cellpadding="5" cellspacing="1" class="menu_backcolor" id="t2tid" width="900">
							<thead>
								<tr class="right_backcolor">
									<th colspan="7" nowrap="nowrap" class="Corner">
										<?php echo strtoupper($fstring); ?>
									</th>
								</tr>
								<tr class="right_backcolor">
								...
								<tr class="right_backcolor">
									<th nowrap="nowrap" class="Corner">Account Type</th>
									<th width="138" nowrap="nowrap" class="Odd">Account Title</th>
									<th width="129" nowrap="nowrap" class="Odd">Account Code</th>
									<th width="129" nowrap="nowrap" class="Odd">Debit</th>
									<th width="120" nowrap="nowrap" class="Odd">Credit</th>
									<th width="185" colspan="2" nowrap="nowrap" class="Odd"></th>
								</tr>
							</thead>
							<?php
							if ($enddate <= $eod) {
								...
								while ($k < $maxPage && $numrows > ($k + $skip)) {
									...
									if ($row["ACCT_NO"] == "300110") {
										$row["debitbal"] = $ovd;
										$row["creditbal"] = $ovd;
									}
									if ($row["ACCT_NO"] == "600110") {
										$row["debitbal"] = $row["debitbal"] + $ovdcur;
										$row["creditbal"] = $row["creditbal"] + $ovdcur;
									}
									if ($row["ACCT_NO"] == "600120") {
										$row["debitbal"] += $ovdst;
										$row["creditbal"] += $ovdst;
									}
									if ($row["ACCT_NO"] == "600130") {
										$row["debitbal"] += $ovdsav;
										$row["creditbal"] += $ovdsav;
									}
									if ($row["ACCT_NO"] == "600140") {
										$row["debitbal"] += $ovdtg;
										$row["creditbal"] += $ovdtg;
									}
									if ($row["ACCT_NO"] == "600150") {
										$row["debitbal"] += $ovdes;
										$row["creditbal"] += $ovdes;
									}
									//}	
							...
							?>
									<tr <?php echo ($k % 2 == 0) ? "class='treven'" : "class='trodd'"; ?>>
										<td nowrap="nowrap"><?php echo $row["ACCT_SB_NAME"]; ?></td>
										<td nowrap="nowrap"><?php echo $row["ACCT_SBT_NAME"]; ?></td>
										<td nowrap="nowrap"><?php echo $row["ACCT_NO"]; ?></td>
										<td nowrap="nowrap"><?php if ($row["debitbal"] < 0) {
								...
								<?
									...
									<tr <?php echo ($k % 2 == 0) ? "class='treven'" : "class='trodd'"; ?>>
										...
										<td nowrap="nowrap"><b><? echo number_format(abs($sumdebit), 2); ?></b></td>
										<td nowrap="nowrap"><b><? echo number_format(abs($sumcredit), 2); ?></b></td>
