	            ...
	            <table width="363" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="199"><select name="eyear" id="eyear">
                      ...
                      <input name="search2" type="button" class="table_text1" id="search2" onclick="javascript:doSearch('tribalance_report.php')" value="Search"/><a href="#" onclick="getpage('change_trial_balance.php','page')">Change</a></td>
                  </tr>
				  </table>
	          </div></td>
	        </tr>
