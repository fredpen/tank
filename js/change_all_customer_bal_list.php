								...
								<table width="688" border="0">
									<tr>
										...
										<td nowrap="nowrap">&nbsp;&nbsp;Order By :
											...
											<input name="search2" type="button" class="table_text1" disabled="disabled" id="search2" onclick="javascript:doSearch('change_all_customer_bal_list.php')" value="Search" />
										</td>
										<td>&nbsp;</td>
										<td>&nbsp;</td>
									</tr>
								...
								<table border="0">
									<tr>
										...
										<td>Page
											...
											&nbsp;
											<input name="search22" type="button" class="table_text1" id="search22" onclick="javascript:doSearch('change_all_customer_bal_list.php');" disabled="disabled" value="Go" />
										</td>
									</tr>
								</table>
							</td>
								...
								<tr <?php echo ($k % 2 == 0) ? "class='treven'" : "class='trodd'"; ?>>
									...
									<?php if (($searchby == '30') || ($searchby == '31') || ($searchby == '32') || ($searchby == '33') || ($searchby == '34') || ($searchby == '35') || ($searchby == '36') || ($searchby == '37') || ($searchby == '38')) { ?>
										...
										<td nowrap="nowrap"><?php echo number_format($all_a["repay_int"], 2);
															$Rep_int += $all_a["repay_int"]; ?></td><?php }
																																				if ($row["GL_TYPE"] != '20001') {
																																					$id2 = $row["ACCT_ID"] . '_' . $row["ACT"];
																																				} ?>
									<td nowrap="nowrap"><input type="text" id="<?php echo $id2; ?>" name="<?php echo $id2; ?>" value="<?php echo $row["CUS_BAL"]; ?>" />
										<input name="search" type="button" class="table_text1" id="search" onclick="javascript:getpageUpdateGl('<?php echo $id2; ?>','change_all_customer_bal_list.php','page')" value="Update" />
									</td>
