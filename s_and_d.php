...
<div align ="center" id="data-form" > 
	...
	<form action="" method="get" id="form1">
		...
		<br />
		<h3><strong><font size='12'>Sales and Distribution Portal</font></strong></h3>

		
		
		<table border ="1" width="95%" style="border-collapse: collapse;">
			<tr> 
				<td colspan="3"><h3>SETUP</b> </h3>
				<td >
			...
			<tr> 
				<td  colspan="3" ><h3>TRANSACTIONS</h3></td>
				<td >
			...
			<tr> 
				<td   colspan="2" ><h3>TRANSACTIONS</h3></td>
				<td >
