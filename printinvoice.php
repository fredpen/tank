...
<div align="center" id="data-form">
	...
	<form action="" method="get" id="form1">
		<h3 class="noprint"><strong>Print Invoice </strong></h3>
				...
				<table border="0" width="100%" id="recpt">
					<tr>
						<td align="center" colspan="8">
							...
							<b>Customer Invoice/Waybill </b><br />
							...
							<table border="1" width="100%">
								...
								<tr>
									...
									<td>
										...
										if ($invoice_details[0]['address1'] != '') {
											echo  '<br />' . $invoice_details[0]['address1'];
										}
										if ($invoice_details[0]['address2'] != '') {
											echo  '<br />' . $invoice_details[0]['address2'];
										}
										?>
									</td>
									<td nowrap="nowrap">
						...
						<td align="center" colspan="8">
							<table border="1" width="100%">
								...
								<tr>
									...
									<td align="right" colspan="3">
										<b>Total Cost</b> &nbsp;&nbsp;<?php echo $thetotalcost;
																		echo " (" . $dbobject->convert_number_to_words($thetotalcost) . ")"; ?>
									</td>
								</tr>
					...
					<tr>
						<td> <b>Payment Ref : </b></td>
						<td colspan="7"> <?php echo $pmtref; ?> </td>
					</tr>
					<tr>
						<td> <b>Amount Utilized : </b></td>
						<td colspan="7" align="left"> <?php echo number_format($pmtrefamtused, 2);
														echo "  (" . $dbobject->convert_number_to_words($pmtrefamtused) . ")";  ?> </td>
					</tr>
					<tr>
						<td align="center" colspan="8">
							<table border="1" width="100%">
