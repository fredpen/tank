...
<div align ="center" id="data-form" > 
	...
	<form action="" method="get" id="form1">
		<h3><strong><font size='10'>Bank Definition </font></strong></h3>
		<?php
...
//****			
		...
		<table border="0"  style="border:1px solid black;padding:1px;border-collapse:separate;border-radius:15px">
			<tr >
				...
				<td colspan="2">
					<input type="text" name="bank_code" id="bank_code" value="<?php echo $bank_code; ?>" <?php if ($bank_code != ''){echo 'style="background-color:lightgray" readonly';} ?> placeholder="Enter Bank ID" />
				</td>
				<td >
				
				  <input type="button" name="refreshbutton" id="submit-button" value="Refresh" 
					onclick="javascript:  getpage('bankdef.php?','page');" />
		...
		<table>
			...
			<tr>
				...
				<td >
				 ...
				 <?php $calledby = 'bankdef'; $reportid = 38; include("specificreportlink.php");  ?>
...
<script>
	...
	function savevendor(){
		if (confirm('Are you sure the entries are correct?')) 
		{
			...
			var $form_bank_code = $('#bank_code').val();$form_bankaddr = $('#bankaddr').val(); var $form_bank_name = $('#bank_name').val();
