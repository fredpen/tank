...
<div align ="center" id="data-form" > 
	...
	<form action="" method="get" id="form1">
		<h3><strong><font size='10'>Void Requisition Balance </font></strong></h3>
		<?php
	...
	// retrieve product		
			...
			for ($i=0;$i<$count_products;$i++){
				...
				if ($row['qty_asked'] > $row['qty_booked'] ){$show_void_button = 1;}else{$show_void_button = 0;}
		...
		<table>
		  <tr>
			...
			<td  align="right" nowrap="nowrap">
				  ...
				  <input type="button" name="approvebutton" id="submit-button" title="Void Requisition Balance" value="Void Balance" 
					onclick="javascript: voidreqbal(); ">
			...
			<td>
				<?php $calledby = 'voidreqbalance'; $reportid = 43; include("specificreportlink.php");  ?>
			</td>
		  </tr>
