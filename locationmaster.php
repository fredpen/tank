			...
			<div style="overflow-x:auto;">
				<table border="0" style="border:1px solid black;padding:1px;border-collapse:separate;border-radius:15px">
					<tr>
						...
						<td>
							<input type="text" name="loccd" id="loccd" value="<?php echo $loccd; ?>" <?php if ($loccd != '') {
																											echo 'readonly';
																										} ?> placeholder="Enter Location ID" />
						</td>
						<td colspan="2">

							<input type="button" name="refreshbutton" id="submit-button" value="Refresh" onclick="javascript:  getpage('locationmaster.php?','page');" />
