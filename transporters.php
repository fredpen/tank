...
<div align ="center" id="data-form" > 
	...
	<form action="" method="get" id="form1">
		<h3><strong><font size='10'>Transporters Definition </font></strong></h3>
		<?php
...
//****			
		...
		<table border="0"  style="border:1px solid black;padding:1px;border-collapse:separate;border-radius:15px">
			<tr >
				...
				<td colspan="2">
					<input type="text" name="trasno" id="trasno" value="<?php echo $trasno; ?>" <?php if ($trasno != ''){echo 'style="background-color:lightgray" readonly';} ?> placeholder="Enter Transporter ID" />
				</td>
				<td >
				
				  <input type="button" name="refreshbutton" id="submit-button" value="Refresh" 
					onclick="javascript:  getpage('transporters.php?','page');" />
				</td>
...
<script>
	...
	function savetrasno(){
		if (confirm('Are you sure the entries are correct?')) 
		{
			...
			var $form_transno = $('#trasno').val();$form_address = $('#address').val(); var $form_company = $('#company').val();
