...
<div align ="center" id="data-form" > 
	...
	<?php 
		...
		include "reportcondition.php";
			...
			$query =  "SELECT a.custno,a.refno, a.descriptn, a.pmtdate,a.amount,a.pmtmode,a.bank_code,a.dd_no,".
					...
					" WHERE a.advrefund1=1 ".
						$holdadditionalwhereclause .
				" ORDER BY pmtdate desc";
	...
	<form name="form1" id="form1" method="post" action="">
		...
		<div id="print_table">
		<p ><h3><strong><font size='12'>Customer Payments</font></strong></h3></p>
