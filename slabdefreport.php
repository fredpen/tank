...
<div align ="center" id="data-form" > 
	...
	<?php 
		...
		//$holdadditionalwhereclause = $additionalwhereclause <> ""?" and " . $additionalwhereclause :"";
			...
			$query = "SELECT  a.slabdesc, b.* FROM slabdef a, slabdisc b where trim(a.slabid)=trim(b.slabid) ORDER BY a.slabdesc,b.lbound ";
	...
	<form name="form1" id="form1" method="post" action="">
		...
		<div id="print_table">
		<h3><strong><font size='12'>Slab Discount Definition </font></strong></h3>
		<table >
						...
						<table  border="0" cellpadding="5" cellspacing="1" class="menu_backcolor" id="userlistTable">
							<thead>
								<tr class="right_backcolor">
									...
									<th nowrap="nowrap" class="Odd">Slab ID</th>
							...
							?>
									...
									<tr <?php echo ($k%2==0)?"class='treven'":"class='trodd'"; ?> >
										...
										<td nowrap="nowrap"><?php echo $row["slabdesc"];?></td>
