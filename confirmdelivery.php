...
<div align ="center" id="data-form" > 
	...
	<form action="" method="get" id="form1" novalidate >
		<h3><strong><font size='10'>Confirm Delivery</font></strong></h3>
		<?php
			...
			$invoice_no ='';$invoice_dt ='';$salespsn ='';$deliveryaddress ='';
					...
					if  ($check_count_products != $thecount_products)
					{
					...
					}else
						{
							for ($i=0; $i < $check_count_products; $i++)
							{
								...
								$thevehcno = $rowmore['vehcno'];$theinvoiceno = $rowmore['invoice_no'];
		...
		<table    >
			...
			<tr>
				...
				<td>
					<?php $calledby = 'confirmdelivery'; $reportid = 10; include("specificreportlink.php");  ?>
				</td>
			</tr>	
			<tr>
							...
							<tr>
								<td align="center" colspan="8">
									<table border="1" width="100%">
										...
										<?php $thetotalqty = 0; $thetotalcost = 0; for ($w=0;$w<$count_products ;$w++) { ?>
										<tr>
											<td>
										...
										<tr>
											...
											<td align="center" colspan="4">
												...
												<?php if ($count_products==1 && $confirmed == 0) {?>
													  ...
													  <input type="button" name="approvebutton" id="submit-button" title="Generate Way Bill/Invoice" value="Confirm Delivery" 
														onclick="javascript: confirmdelivery();">
