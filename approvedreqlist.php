...
<div align="center" id="data-form_report">
	...
	<form name="form1" id="form1" method="post" action="">
		...
		<h3><strong>Approved Requisistions </strong></h3>
		...
		<div width="95%" style="overflow-x:auto;">
			<table>
				...
				<tr>
					<td>
						<input type="button" name="closebutton" id="submit-button" title="List Requisitions Awaiting Approval" value="List Requisitions" onclick="javascript:  getpage('awaitingapproval.php?','page');" />
