					...
					<tr>
						...
						<td colspan="2">
							...
							<select name="loccd" id="loccd" onChange="javascript: 
								...
								?>
									<option value="<?php echo trim($lmf_var[$k]['loccd']); ?>" <?php $loc_name = trim($lmf_var[$k]['loc_name']);
																								echo ($loccd == trim($lmf_var[$k]['loccd']) ? "selected" : ""); ?>>
...
<script>
	...
	function myAddItem() {
		...
		if ($form_subloc == '') {
			$addrow = $addrow * 0;
			alert('Sub Inventory is not provided !');
		}
