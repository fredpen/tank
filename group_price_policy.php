...
<div align="center" id="data-form">
	...
	<form action="" method="get" id="form1">
		<h3><strong>
				Customer Category Pricing Policy
			</strong></h3>
		<?php
				...
				<table border="0" style="border:1px solid black;padding:1px;border-collapse:separate;border-radius:15px">
					<tr>
						...
						<td colspan="3">
							...
							$k = 0;
							?>
							<select name="catcd" id="catcd" onChange="javascript: retrievegrprice();">
								<option value=""></option>
								<?php
				...
				<table border="0">
					<tr>
						...
						<td>
							...
							<input type="button" name="refreshbutton" id="submit-button" value="Refresh" onclick="javascript:  	getpage('group_price_policy.php','page');" />
...
<script>
	function retrievegrprice() {
		...
		var $form_catcd = $('#catcd').val();
		var $form_item = $('#item').val();
		var $form_itemdesc = $('#itemdesc').val();
		if ($form_catcd != '' && $form_item != '') {
			getpage('group_price_policy.php?op=getselectitem&item=' + $form_item + '&itemdesc=' + $form_itemdesc + '&catcd=' + $form_catcd, 'page');
		}
