	...
	<form action="" method="get" id="form1">
		...
		<?php
			if ($_SESSION['expense']==1)
			{
				...
				$exprefnoday = substr($transdate,0,2);$exprefnomonth = substr($transdate,3,2);$exprefnoyear = substr($transdate,6,4); 
...
//****			
		...
		<table border ="0"  style="padding:0px;">
			...
			<?php if ($goahead == 1) { ?>
			<tr>
				<td colspan="2"  align = "left"  ><h3>The Transaction Reference is <b><?php echo $exprefno; ?></b></h3></td>
			</tr>
			<?php } ?>
			<tr>
				<td colspan="2">
		...
		<table border="0">
			...
			<tr>
				...
				<td  >
					...
					<?php $calledby = 'generalexpenditure'; $reportid = 62; include("specificreportlink.php");  ?>
...
<script>
	...
	function savepayment(){
		if (confirm('Are you sure the entries are correct?')) 
		{
			...
			var $form_custno = $('#vendorno').val();$form_address1 = $('#address1').val(); var $form_company = $('#company').val();
			var $form_dd_no = $('#dd_no').val();var $form_exprefno = $('#exprefno').val();var $form_pmtmode = $('#pmtmode').val();
				...
				var $form_email = $('#email').val();var $selectexpensetype = $('#expenstype').val();
