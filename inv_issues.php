...
<div align ="center" id="data-form" > 
	...
	<?php 
		...
		include "reportcondition.php";
			...
			$query = "SELECT a.*,b.loc_name FROM inv_issues a , lmf b WHERE trim(a.loccd) = trim(b.loccd) " .
							$holdadditionalwhereclause . " ORDER BY STR_TO_DATE(a.issued_dt , '%d/%m/%Y') desc, a.item ";

		$query_summary = "SELECT sum(a.qtyissued) qtyissued FROM inv_issues a WHERE 1 = 1 " .
			...
			if($numrows>0){
				...
				$summary_qtyissued = $row_summary['qtyissued'];
			}
	...
	<form name="form1" id="form1" method="post" action="">
		...
		<div id="print_table">
		<h3><strong>Inventory Issues </strong></h3>
						...
						<table  border="0" cellpadding="5" cellspacing="1" class="menu_backcolor" id="userlistTable">
							<thead>
								<tr class="right_backcolor">
									<th   class="Corner">&nbsp;</th>
									<th   class="Odd">S/N</th>
									<th   class="Odd">Issue No</th>
									<th   class="Odd">Issued Date</th>
									<th   class="Odd">Issued To</th>
									<th   class="Odd">Issued From</th>
									<th   class="Odd">Sub Inventory</th>
									<th   class="Odd">Item</th>
									<th   class="Odd">Qty Issued</th>
									<th  >&nbsp;</th>
								</tr>
							</thead>
							<?php 
							...
							?>
									...
									<tr <?php echo ($k%2==0)?"class='treven'":"class='trodd'"; ?> >
										...
										<td   align="right"><?php echo $row['issued_dt'];?></td>
										...
										<td   align="right"><?php echo number_format($row['qtyissued'],2);?></td>
										<td  ></td>
									</tr>
							<?php 
									//} //End For Loop
							...
							?>
									...
									<tr <?php echo ($k%2==0)?"class='treven'":"class='trodd'"; ?> >
										...
										<td  ></td>
										<td  ></td>
										<td   align="right"><strong><?php echo number_format($summary_qtyissued,2);?></strong></td>
										<td  ></td>
									</tr>
