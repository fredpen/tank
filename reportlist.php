	...
	$dbobject = new dbfunction();
			...
			switch (true)
			{
				case $reportgrp=='0' :
					...
					$thereportgrp = '';$_SESSION['reportgrp'] = $reportgrp;
					break;
			...
			$filter = "";
			if(trim($keyword)!=''){$filter=" AND $searchby like '%$keyword%' ";}
...
?>
	...
	<div align ="center" id="data-form" > 
		...
		<form >
			<h3><strong><font size='14'>Reports List</font></strong></h3>
			<?php
					...
					<tbody>
						...
						?>					
							...
							<tr <?php echo ($k%2==0)?"class='treven'":"class='trodd'"; ?> >
								...
								<td nowrap="nowrap"><a 
										href="javascript: getpage('reportheader.php?reportname=<?php echo trim($row['procname']);?>
