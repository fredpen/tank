				...
				<tr>
					...
					<?php if ($show_void_button == 1) { ?>
						<td align="right" nowrap="nowrap">
							...
							<input type="button" name="approvebutton" id="submit-button" title="Reverse Loading Slip" value="Reverse Slip" onclick="javascript: reverseslip();">
					...
					<td>
						<?php $calledby = 'reverseloadingslip';
						$reportid = 42;
