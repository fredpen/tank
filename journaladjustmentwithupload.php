...
<div align ="center" id="data-form" > 
	...
	<form action="" method="POST" id="form1"  enctype="multipart/form-data">
		<h3><strong><font size='12'>Upload Journal Entries</font></strong></h3>
		<?php
			...
			$chartcodeArray = Array(); $creditArray = Array();$debitArray = Array(); $ddArray = Array();$mmtArray = Array(); $yyyyArray = Array();
			...
			$count_populate_journal = 0;$hold_totaldebit = 0;$hold_totalcredit = 0;
		...
		<div style="overflow-x:auto;" >
			...
			<br />
				...
				<table border="0"  style="border:1px solid black;padding:10px;border-collapse:separate;border-radius:15px">
					...
					<tr >
						<td><p id="size"><b>Upload From Excel </b></p> </td>
					...
					<tr>
						...
						<td align="center" colspan="2">
							<table><tr><td><input type="button" name="addaccount" id="submit-button" title="Populate with Verified File" value="Populate" onclick="myAddAcountExcel();"></td></tr></table>
						</td>
					</tr>
				</table>
		...
		<div style=" overflow-x:auto;" >
			<table border="0">
				...
				<tr class="right_backcolor">
					...
					<td class="Odd"  >
						 <input  type="text" style="width:150px;background:transparent;border:none;"  tabindex="-1"  id="hold_totaldebit" value=<?php echo $hold_totaldebit; ?> readonly /></td>
					<td  class="Odd" ><b>Total Credit</b></td>
					<td  class="Odd" >
						 <input  type="text" style="width:150px;background:transparent;border:none;"  tabindex="-1" id="hold_totalcredit" value=<?php echo $hold_totalcredit; ?> readonly /></td>
					</td >
					<td >&nbsp;</td>
				</tr>
				</thead>
			...
			<tr >
			  ...
			  <tr>
				...
				<td colspan="3"  nowrap="nowrap">
					...
					<?php $calledby = 'journaladjustmentwithupload'; $reportid = 78; include("specificreportlink.php");  ?>
