...
<div align ="center" id="data-form" > 
	...
	<form action="" method="get" id="form1">
		<h3><strong><font size='10'>Cash Receipts </font></strong></h3>
		<?php
				...
				if($op=='saving')
				{
				  ...
				  <?php }
					...
					if ($goahead==1)
					{
						...
						{
							$to = $email;
							$subject = "Bizmaap Payment Acknowledgement";
							...
							//additional headers
							$headers .= 'From: Bizmaap Online<no_replyt@iyallasoft.com.ng>' . "\r\n";
							//send email
							mail($to,$subject,$mailContent,$headers);			
							echo "<br/><h3><b>Mail sent to ".$email."</b></h3>";
						}else {echo "<br/><h3><b>Mail not sent to ".$email."</b></h3>";
...
//****			
		...
		<table border="0">
			...
			<tr>
				...
				<td >
					<?php $calledby = 'cshpayments'; $reportid = 64; include("specificreportlink.php");  ?>
				</td>
			</tr>
