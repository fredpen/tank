				...
				<table border="0" style="border:1px solid black;padding:1px;border-collapse:separate;border-radius:15px">
					<tr>
						...
						<td>
							...
							<input type="button" name="refreshbutton" id="submit-button" value="Refresh" onclick="javascript:  getpage('item_settings.php?','page');" />
					...
					<tr>
						<td colspan="4" nowrap="nowrap">
							<div title="WIP stands for Work in Progress"><b>Stock Position =></b>
								...
								&nbsp;&nbsp;<b>Usable :</b>
								<?php echo number_format($useable_onhand, 2); ?>
							</div>
						</td>
					</tr>
					<tr>
				...
				<table>
					...
					<tr>
						...
						<td>
							...
							<input type="button" name="showtheinference" id="submit-button" value="Show Inferences" onclick="javascript:  showinferences();" />
...
<script>
	...
	function saveicitem() {
		if (confirm('Are you sure the entries are correct?')) {
			...
			$form_reorderqty = $('#reorderqty').val();
			var $form_minusage = $('#minusage').val();
			var $form_maxusage = $('#maxusage').val();
			var $form_minlead = $('#minlead').val();
			var $form_maxlead = $('#maxlead').val();
			var $form_avgusage = $('#avgusage').val();
			var $form_avglead = $('#avglead').val();
			var $form_minstock = $('#minstock').val();
			var $form_maxstock = $('#maxstock').val();
