...
<div align ="center" id="data-form" > 
	...
	<?php 
		...
		include "reportcondition.php";
			...
			$query = "SELECT a.item,a.itemdesc,a.itemtype,a.scprice,a.otprice,a.prvalidity,a.lstmodify ".
					" FROM icitem a WHERE 1 = 1  " .
	...
	<form name="form1" id="form1" method="post" action="">
		...
		<div id="print_table">
		<h3><strong>Inventory Items </strong></h3>
		<table >
						...
						<table  border="0" cellpadding="5" cellspacing="1" class="menu_backcolor" id="userlistTable">
							<thead>
								<tr class="right_backcolor">
									...
									<th   class="Odd">Self Collection Price</th>
									<th   class="Odd">Delivery Price</th>
									<th   class="Odd">Validity Date</th>
									<th   class="Odd">Last Modified</th>
									<th  >&nbsp;</th>
								</tr>
							</thead>
							<?php 
							...
							?>
									...
									<tr <?php echo ($k%2==0)?"class='treven'":"class='trodd'"; ?> >
										...
										<td   align="right"><?php echo number_format($row['scprice'],2);?></td>
										<td   align="right"><?php echo number_format($row['otprice'],2);?></td>
										<td   align="right"><?php echo trim($row['prvalidity']);?></td>
										<td   align="right"><?php echo trim($row['lstmodify']);?></td>
										<td  ></td>
									</tr>
							<?php 
									//} //End For Loop
