...
<div align ="center" id="data-form" > 
	...
	<form action="" method="get" id="form1">
		<h3><strong><font size='10'>Item Master </font></strong></h3>
		<?php
		...
		<table border="0"  style="border:1px solid black;padding:1px;border-collapse:separate;border-radius:15px">
			<tr >
				...
				<td colspan="2" >
					<input type="text" name="item" id="item" value="<?php echo $item; ?>" <?php if ($item != ''){echo "style='color:'" ;echo 'readonly';} ?> placeholder="Enter Item ID" />
				</td>
				<td >
		...
		<table>
			...
			<tr>
				...
				<td nowrap="nowrap">
					  ...
					  <input type="button" name="itemsetting" id="submit-button" value="Item Setting" 
...
<script>
	...
	function saveicitem(){
		if (confirm('Are you sure the entries are correct?')) 
		{
			...
			var $form_item = $('#item').val();$form_itemtype = $('#itemtype').val(); var $form_itemdesc = $('#itemdesc').val();
			
			var $form_chartcode = $('#chartcode').val();var $form_pack = $('#pack').val();var $form_description = $('#description').val();
			
				var $form_volfactor = $('#volfactor').val();var $form_unitofmeasure = $('#unitofmeasure').val();
