...
<script type="text/javascript" src="js/tablehighlight.js"></script>
	<div align ="center" id="data-form" > 
		...
		<form name="form1" id="form1">
			<h3><strong><font size='12'>Report Portal</font></strong></h3>
			
			<table  >
				<tr><td colspan="4"><div id="display"></div></td></tr>
				
				<tr><td colspan="4" align="center"><b>Search for Applicable Parameters</b></td></tr>
				<tr>
