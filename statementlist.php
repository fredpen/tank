	...
	<form action="" method="get" id="form1">
		...
		?>
			...
			<table border = "1">
				...
				<tr>
					<td>Name: </td> <td><?php echo $row_QueryStmt['surname'] . ' ' . $row_QueryStmt['middlename'] . ' ' , $row_QueryStmt['firstname']; ?> </td>
				</tr>
				<tr>
					<td>House Address:</td> <td> <?php echo $row_QueryStmt['flataddress']; ?> </td>
				</tr>
				<?php } ?>
				<tr>
					<td>Start Date: <?php echo $startdate ; ?></td> <td>&nbsp;&nbsp;&nbsp;&nbsp; End Date: <?php echo $enddate; ?> </td>
				</tr>
		...
		<table>
		  <tr>
			...
			<td  align="right" nowrap="nowrap">
				<label>
				  <input type="button" name="closebutton" id="submit-button" value="Close" 
					onclick="javascript:  getpage('statement.php','page');">
				</label>
			</td>		
