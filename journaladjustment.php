...
<div align="center" id="data-form">
	...
	<form action="" method="POST" id="form1" enctype="multipart/form-data">
		<h3><strong>Journal Entries</strong></h3>
		<?php
				...
				<table border="0">
					<thead>
						<tr class="right_backcolor">
							...
							<td class="Odd">
								<input type="text" style="width:150px;background:transparent;border:none;" tabindex="-1" id="hold_totaldebit" value=0 readonly />
							</td>
							<td class="Odd"><b>Total Credit</b></td>
							<td class="Odd">
								<input type="text" style="width:150px;background:transparent;border:none;" tabindex="-1" id="hold_totalcredit" value=0 readonly />
							</td>
							</td>
							<td>&nbsp;</td>
						</tr>
			...
			<table>
				...
				<tr>
					...
					<td align="right" nowrap="nowrap" colspan="2">
						...
						<input type="button" name="savebutton" id="submit-button" value="Save Journal" onclick="mysavefunction()">
					...
					<td nowrap="nowrap">
						...
						<?php $calledby = 'journaladjustment';
						$reportid = 78;
...
<script>
	function myAddAcount(accountaction) {
		...
		if ($accountamount == 0) {
			$addrow = $addrow * 0;
			alert('Please Enter an amount for the Account');
		}
		if ($form_selectaccount == '') {
			$addrow = $addrow * 0;
