			...
			<div style="overflow-x:auto;">
				<table border="0" style="border:1px solid black;padding:1px;border-collapse:separate;border-radius:15px">
					<tr>
						...
						<td>
							<input type="text" name="vehcno" id="vehcno" value="<?php echo $vehcno; ?>" <?php if ($vehcno != '') {
																											echo 'style="background-color:lightgray" readonly';
																										} ?> placeholder="Enter BRV ID" />
						</td>
						<td>

							<input type="button" name="refreshbutton" id="submit-button" value="Refresh" onclick="javascript:  getpage('brvdef.php?','page');" />
				...
				<table>
					...
					<tr>
						...
						<td>
							...
							<input type="button" name="deletebutton" id="submit-button" value="Delete" onclick="deletevehcno();" />
