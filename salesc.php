...
<div align ="center" id="data-form" > 
	<?php 
		...
		include "reportcondition.php";
			...
			$query = "SELECT  b.item,b.itemdesc,a.custno,a.ccompany,a.station, ".
				" sum(b.store_qty) as quantity ,".
				"  sum(b.store_qty*b.price) AS invoice_am ".
				" FROM invoice a, inv_detl b ".
				" WHERE trim(a.slip_no) = trim(b.slip_no)  AND b.store_qty > 0 and a.reversed = 0 ".
						$holdadditionalwhereclause . 
						" group by  a.ccompany,a.custno ,b.item,b.itemdesc".
						" ORDER BY  a.ccompany,a.custno ,b.item,b.itemdesc";
	...
	<form name="form1" id="form1" method="post" action="">
		...
		<div id="print_table">
		<h3><strong>Customer Wise Sales </strong></h3>
						...
						<table  border="0" cellpadding="5" cellspacing="1" class="menu_backcolor" id="userlistTable">
							...
							?>
									...
									<tr <?php echo ($k%2==0)?"class='treven'":"class='trodd'"; ?> >
										<td  >&nbsp;</td>
										<td  ><?php echo $k;?></td>
										<td  ><?php echo trim($row["ccompany"]) ."-" . trim($row["custno"]);?></td>
