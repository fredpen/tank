...
var bsa = {
	...
	track:function(link,zone){
		...
		var trimg = new Image();
		trimg.src = "http://stats.buysellads.com/click.gif?b="+b+"&z="+z+"&r="+Math.random();
		bsa.pause();
	...
	impression:function(e){
		...
		for(var j=0;j<zc.length;j++){
			...
			var trImg = new Image();
			trImg.src = "http://stats.buysellads.com/imp.gif?z="+z+"&r="+Math.random();
			trImg.onload = function(){};
		}
	},
	...
	adverts:function(bnrs){
		...
		banTrImg.src = "http://stats.buysellads.com/imp.gif?b="+b+"&r="+Math.random();
