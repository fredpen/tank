...
<div align="center" id="data-form">
	...
	<form action="" method="get" id="form1">
		<h3><strong>
				Approval for Release of Product
			...
			<table>
				...
				<tr>
					<td align="right" nowrap="nowrap">
						...
						<input type="button" name="approvebutton" id="submit-button" value="Approve" <?php if ($approve_ok == 1 || $refuse == 1) {
					...
					<td nowrap="nowrap">
						...
						<input type="button" name="refusebutton" id="submit-button" value="Refuse" <?php if ($refuse == 1) {
																										echo 'style="display:none"';
																									} ?> onclick="javascript:
